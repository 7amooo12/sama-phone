...
DO $$
BEGIN
    RAISE NOTICE '✅ All production batch management functions have been created/updated';
    ...
    RAISE NOTICE '🔧 Fixed: Changed operation_type from "production_update" to "production"';
    RAISE NOTICE '📋 Valid operation types: production, adjustment, import, export';
END $$;
