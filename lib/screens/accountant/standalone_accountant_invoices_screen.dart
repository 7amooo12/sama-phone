...
class StandaloneAccountantInvoicesScreen extends StatefulWidget {
  const StandaloneAccountantInvoicesScreen({super.key});

  @override
  State<StandaloneAccountantInvoicesScreen> createState() => _StandaloneAccountantInvoicesScreenState();
}

class _StandaloneAccountantInvoicesScreenState extends State<StandaloneAccountantInvoicesScreen> {
      ...
      appBar: CustomAppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              // Refresh functionality will be handled by AccountantInvoicesScreen
            },
          ),
        ],
      ),
