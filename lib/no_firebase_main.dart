...
// This is a simplified version that does not depend on Firebase
void main() {
  ...
  // Add an error handler to catch any Firebase-related issues
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.green.safeOpacity(0.1),
