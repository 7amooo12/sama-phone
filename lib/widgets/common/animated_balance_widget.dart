...
class _AnimatedBalanceWidgetState extends State<AnimatedBalanceWidget>
              ...
              builder: (context, animatedBalance, child) {
                ...
                return Text(
                  ...
                  style: widget.textStyle.copyWith(
                    ...
                    height: 1.2, // Improved line height for Arabic text
                    letterSpacing: 0.3, // Better character spacing
                  ),
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                  textAlign: TextAlign.right, // RTL alignment for Arabic
                  textDirection: ui.TextDirection.rtl, // Explicit RTL direction
                );
              },
            ),
          ),
  ...
  String _buildDisplayText(double balance) {
    // Use the proper treasury balance formatter for full precision
    if (widget.showCurrencySymbol) {
      // Use the formatTreasuryBalance method which includes currency symbol and full precision
      final formattedBalance = Formatters.formatTreasuryBalance(balance, widget.currencySymbol);
      final parts = <String>[];
      ...
      // For cases without currency symbol, use full precision formatting
      final formattedBalance = _formatFullPrecision(balance);
      final parts = <String>[];
  ...
  String _formatFullPrecision(double number) {
    // Always show full precision with proper thousand separators for treasury balances
