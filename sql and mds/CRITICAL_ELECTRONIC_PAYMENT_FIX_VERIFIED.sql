-- =====================================================
-- CRITICAL ELECTRONIC PAYMENT FIX - VERIFIED VERSION
-- =====================================================
-- This script fixes the database constraint violation in dual wallet transactions
-- Syntax verified for PostgreSQL/Supabase compatibility
-- =====================================================
